...
from image.image_handler import get_get_sprite, get_quiz_box, get_get_quiz_sprite
...
def quiz_window(quiz):
    ...
    while run:
        large_text = pygame.font.Font("font_src/PAPYRUS.TTF", 30)
        ...
        screen.blit(get_quiz_box(), (0, 450))
        screen.blit(text_surf, text_rect)
        alt = 250
        for alternative_text in alternatives_text:
            alternative_text[1].center = (alt, 560)
            alt += 150
