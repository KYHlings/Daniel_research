...
def run_over_image():
    lose_frog_image = pygame.image.load("image/backgrounds_src/run_over.jpg")
    lose_frog_image = pygame.transform.scale(lose_frog_image, (800, 600))
    return lose_frog_image
...
def get_quiz_box():
    quiz_box = pygame.image.load("image/backgrounds_src/quiz_box.jpg")
    quiz_box = pygame.transform.scale(quiz_box, (800,150))
    return quiz_box
